...
<link rel="stylesheet" href="{$url.static_new}fonts/metinfo-icon/metinfo-icon.css">
				...
				<div>
					...
					<div class="btn-group {$headnav_ml}">
						...
						<ul class="dropdown-menu mt-2">
							...
							<if value="$data['check_update']['type'] eq 2 && $data['auth']['checkupdate'] eq 1">
	                        ...
	                        <if value="$c['met_agents_app']">
	                    	<list data="$data['applist']" name="$v">
							<a href="javascript:;" class='dropdown-item px-3 py-2' data-toggle="modal" data-target=".pageset-nav-modal" data-url='{$v.url}'>{$v.appname}</a>
							</list>
							</if>
						</ul>
					</div>
				...
				<div class="float-right">
					<div class="btn-group {$headnav_ml}">
						...
						<ul class="dropdown-menu dropdown-menu-right mt-2">
                            ...
                            <if value="$data['auth']['nav_setting'] eq 1">
							...
							<if value="$data['auth']['function_complete'] eq 1 && $c['met_agents_metmsg']">
							<a href="javascript:;" class='dropdown-item px-3 py-2' data-toggle="modal" data-target="#functionEncy" data-modal-size="lg" data-modal-url="#pub/function_ency" data-modal-refresh="one" data-modal-fullheight="1" data-modal-title="{$word.funcCollection}" data-modal-oktext="" data-modal-notext="{$word.close}">{$word.funcCollection}</a>
							</if>
					...
					<a href='{$url.site_admin}#/home' class="btn btn-outline-light border-none {$headnav_ml}" target='_blank'>{$word.oldBackstage}</a>
					<if value="!$c['met_agents_switch']">
		...
		<div class="modal-content bg-none border-none">
			<div class="modal-body text-center">
				<div class="d-inline-block">
					...
					<img src="{$url.own_tem}images/uiset_guide.gif" width="800" class="bg-white p-3">
				</div>
			</div>
		</div>
	</div>
