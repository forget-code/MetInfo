...
-->
				...
				<div style="padding:10px;text-align:center; line-height:1.5; color:#888;">{$_M['word']['installation_template']}<br/>{$_M['word']['install_application']}<a href="{$_M[url][site_admin]}index.php?n=appstore&c=appstore&a=doappdetail&type=app&no=10079&lang={$_M[lang]}&anyid=65" target="_blank">{$_M['word']['template_assistant']}</a></div>
			</div>
