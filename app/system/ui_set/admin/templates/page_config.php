...
<form action="{$url.own_name}c=index&a=doset_page_config&classnow={$data.classnow}&id={$data.id}" data-submit-ajax="1">
	<div class="metadmin-fmbx">
		...
		<dl>
			...
			<dd class="form-group">
				<input type="text" name="list_length" value="{$data.list_length}" placeholder="{$word.default_values}{$word.marks}{$data.list_length_default}" required class="form-control w-a">
			</dd>
		</dl>
		</if>
		<if value="$data['module'] eq 3 || $data['module'] eq 5">
