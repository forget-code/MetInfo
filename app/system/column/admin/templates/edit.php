...
<form method="POST" action="{$url.own_name}c=index&a=doEditorsave" class='column-details-form' data-validate_order=".column-details-form" data-submit-ajax='1' enctype="multipart/form-data">
	...
	<div class="metadmin-fmbx">
			...
			<dd>
				<div class='form-group clearfix'>
					...
					<div class="custom-control custom-radio">
						...
						<label class="custom-control-label" for="list_order4-{$checkbox_time}">{$word.columnReverseSort}</label>
					</div>
					<div class="custom-control custom-radio">
						<input type="radio" id="list_order5-{$checkbox_time}" name='list_order' value='5' class="custom-control-input"/>
						<label class="custom-control-label" for="list_order5-{$checkbox_time}">{$word.columnaddOrder}</label>
					</div>
				</div>
			</dd>
		</dl>
		...
		<dl>
			...
			<dd>
				<div class='form-group clearfix'>
					<input type="text" name="list_length" value="{$data.list.list_length}" class="form-control">
				</div>
			</dd>
		</dl>
		</if>
