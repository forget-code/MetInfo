...
class message extends web
{
    ...
    {
        global $_M;
        $this->view('showmessage', $this->input);

        #require_once $this->template('tem/', $this->input);
    }
    ...
    public function checktime($met_fd_time = '')
    {
        ...
        $met_fd_time = load::mod_class('config/config_op','new')->getColumnConf($classnow, 'met_fd_time');
    ...
    {
        global $_M;
        ####$met_nurse_massge_tel = $conlum_configs['met_nurse_massge_tel'];
