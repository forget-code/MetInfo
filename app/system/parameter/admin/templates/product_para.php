		...
		<tfoot>
			<tr>
				...
				<th colspan="6" class="formsubmit">
					...
					<a href="#" class="ui-addlist" data-table-addlist="{$_M[url][own_form]}a=doparaaddlist&module={$_M['form']['module']}&class1={$_M['form']['class1']}&id={$_M['form']['id']}"><i class="fa fa-plus-circle"></i>新增</a>
				</th>
			</tr>
		</tfoot>
	</table>
