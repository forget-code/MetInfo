...
<div class="stat_list">
  <ul>
    <li ><a href="{$_M[url][own_form]}&a=doindex" title="{$_M[word][messageTitle]}">{$_M[word][messageTitle]}</a></li>
    <li ><a href="{$_M[url][adminurl]}anyid={$_M['form']['anyid']}&n=parameter&c=parameter_admin&a=doparaset&module=7" title="{$_M[word][messageVoice]}">{$_M[word][messageVoice]}</a></li>
    <li ><a class="now syset" href="{$_M[url][own_form]}&a=dosyset&class1={$class[class1]}" title="{$_M[word][messageincTitle]}">{$_M[word][messageincTitle]}</a></li>
  </ul>
</div>
