<?php
# 文件名称:editor.php 2009-08-11 13:24:17
# MetInfo企业网站管理系统 
...
switch(intval($lev))
{
	case 0:$level.="<option value='all' $access0>$lang_producteditorAccess0</option>";
	case 1:$level.="<option value='1' $access1>$lang_producteditorAccess1</option>";
	case 2:$level.="<option value='2' $access2>$lang_producteditorAccess2</option>";
	case 3:$level.="<option value='3' $access3>$lang_producteditorAccess3</option>";
}
