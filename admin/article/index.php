<?php
# 文件名称:index.php 2009-08-08 10:58:03
# MetInfo企业网站管理系统 
...
require_once '../login/login_check.php';
	...
	if($langusenow=="en" && $met_e_lang_ok!=1) $class1_info['name']=$met_c_lang_ok==1?$class1_info['c_name']:$class1_info['o_name'];
	if($langusenow=="cn" && $met_c_lang_ok!=1) $class1_info['name']=$met_e_lang_ok==1?$class1_info['e_name']:$class1_info['o_name'];
	if($langusenow=="other" && $met_o_lang_ok!=1) $class1_info['name']=$met_c_lang_ok==1?$class1_info['c_name']:$class1_info['e_name'];
