...
if(!$langid)$langid=0;
$file_nameupdate=$depth."../language/language_".$langeditor.".ini";
$file_nameupdate1=$file_nameupdate;
if(!file_exists($file_nameupdate))$file_nameupdate1=$depth."../language/language_en.ini";
...
if($action=="modify"){
	...
	fclose($fp);
	metsave('../system/lang/langeditoradmin.php?anyid='.$anyid.'&langeditor='.$langeditor."&langid=".$metinfolangid.'&lang='.$lang.'&cs='.$cs,'',$depth);
}else{
