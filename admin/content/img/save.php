...
if($action=="add"){
	...
	metsave('../content/img/index.php?anyid='.$anyid.'&lang='.$lang.'&class1='.$class1,'',$depth,$htmjs);
}
if($action=="editor"){
	...
	$turl  ='../content/img/index.php?anyid='.$anyid.'&lang='.$lang.'&class1='.$class1.'&modify='.$id.'&page='.$page;
