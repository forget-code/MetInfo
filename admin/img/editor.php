...
switch(intval($lev))
{
	case 0:$level.="<option value='all' $access0>$lang_imgeditorAccess0</option>";
	case 1:$level.="<option value='1' $access1>$lang_imgeditorAccess1</option>";
	case 2:$level.="<option value='2' $access2>$lang_imgeditorAccess2</option>";
	case 3:$level.="<option value='3' $access3>$lang_imgeditorAccess3</option>";
}
