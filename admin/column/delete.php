...
if($admin_list2){
okinfo('index.php?lang='.$lang,$lang_modBigclass1);
}
}
...
if($listok)okinfo('index.php?lang='.$lang,"{$lang_deleteTip1}$admin_list[name]{$lang_deleteTip2}");
break;
case 3:
...
if($admin_list2){
okinfo('index.php?lang='.$lang,$lang_modBigclass);
}
