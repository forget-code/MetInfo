<?php
# 文件名称:captcha.class.php 2009-08-18 08:53:03
# MetInfo企业网站管理系统 
...
function CreateCheckCode()
 {
  ...
  $this->mCheckCode = strtoupper(substr(md5(rand()),0,$this->mCheckCodeNum));
   unset($_SESSION['met_capcha_member']);
  $_SESSION['met_capcha_member'] = $this->mCheckCode;
 ...
 */
 function CheckCode($code)
 {
  ...
  if(empty($code)){
      return false;
  }elseif($_SESSION['met_capcha_member']===$code){
     return true; 
  }else {
     return false;
  }
