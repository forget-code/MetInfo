...
$dataoptimize[10000][product]=1;//是否调用按更新时间排序的公共产品列表
$dataoptimize[10000][hitsproduct]=1;//是否调用按点击次数排序的公共产品列表
$dataoptimize[10000][download]=0;//是否调用按更新时间排序的公共下载列表
$dataoptimize[10000][hitsdownload]=0;//是否调用按点击次数排序的公共下载列表
$dataoptimize[10000][img]=1;//是否调用按更新时间排序的公共图片列表
...
$dataoptimize[10001][hitsproduct]=1;//是否调用按点击次数排序的公共产品列表
