...
/*自定义函数结束*/
//以下为执行代码
var module=Number(jQuery("footer").attr('data-module')),navdown=jQuery("#nav_"+jQuery("footer").attr('data-navdown')),classnow=Number(jQuery("footer").attr('data-classnow')),zsfltype=Number(jQuery("footer").attr('data-zsfltype'));
if(module){//全部页面
