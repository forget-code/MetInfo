...
-->
<div>
	<nav class="navbar navbar-default navhover-bg box-shadow-none radius0">
		<div class="container">
<!--
EOT;
...
-->
			<div class="navbar-header row">
				<button type="button" class="navbar-toggler h-50 p-0 collapsed" data-target="#navbar-showproduct"
				data-toggle="collapse">
					<i class="icon wb-chevron-down" aria-hidden="true"></i>
				</button>
				<h1 class="navbar-brand m-0 p-y-0">{$product['title']}</h1>
			</div>
			<div class="navbar-collapse navbar-collapse-toolbar row collapse" id="navbar-showproduct">
...
echo <<<EOT
-->
					<li class='nav-item'><a href="#content-{$i}" class='nav-link'>{$lang_navtab_para}</a></li>
<!--
EOT;
	$i++;
}
